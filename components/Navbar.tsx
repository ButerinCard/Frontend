...
export default function Navbar() {
  ...
  return (
    <div className="absolute z-10 w-full">
      {/* <div className='w-full h-12 bg-white bg-opacity-70 flex justify-between items-center px-20 font-PS2'>
      ...
      <div className="w-full bg-black h-20 flex justify-center items-center" style={{ background: '#3b2b20' }}>
        <h1 className='font-PS2 hidden sm:block text-center sm:text-left text-white lg:text-2xl 2xl:text-4xl px-4' >a homage to Vitalik : Help us upload the largest JPEG on-chain</h1>
        <h1 className='font-PS2 sm:hidden text-center sm:text-left text-white lg:text-2xl 2xl:text-4xl px-4' style={{fontSize:'5px'}}>a homage to Vitalik : Help us upload the largest JPEG on-chain</h1>
